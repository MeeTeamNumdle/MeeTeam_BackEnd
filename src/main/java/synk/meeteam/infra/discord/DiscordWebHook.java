package synk.meeteam.infra.discord;

import static synk.meeteam.infra.discord.exception.ErrorLogAppenderExceptionType.DISCORD_LOG_APPENDER_ERROR;

import java.awt.Color;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;
import synk.meeteam.infra.discord.entity.Author;
import synk.meeteam.infra.discord.entity.EmbedObject;
import synk.meeteam.infra.discord.entity.Field;
import synk.meeteam.infra.discord.entity.Footer;
import synk.meeteam.infra.discord.entity.Image;
import synk.meeteam.infra.discord.entity.JsonObject;
import synk.meeteam.infra.discord.entity.Thumbnail;
import synk.meeteam.infra.discord.exception.ErrorLogAppenderException;
import synk.meeteam.infra.discord.util.ApiCallUtil;
